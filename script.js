document.addEventListener('DOMContentLoaded', function() {
    ...
    if (words.length > 0) {
        ...
        setInterval(() => {
            ...
            words[currentIndex].style.transition = 'opacity 0.5s ease, transform 0.5s ease';
    ...
    function updateActiveDot(targetId) {
        ...
        document.querySelector(`.nav-dot[data-page="${targetId}"]`).classList.add('active');
    }
    ...
    function updateActiveNavLink(targetId) {
        ...
        document.querySelector(`.navigation ul li a[href="#${targetId}"]`).classList.add('active');
    }
